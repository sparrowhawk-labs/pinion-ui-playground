...
return [
    ...
    'subheading' => [
        ...
        'font-debug' => 'JP × Latin font stack 検証 — designer / contributor 向け',
        ...
        'theme-preview' => 'v0.4.0 同梱予定の data-theme="pinion" の tone を user 判断するためのページ。各カードは inline CSS variables で daisyUI v5 token を上書きしている (実装上は themes 配列にまとめる)。',
