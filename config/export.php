...
return [
     ...
     *
     * We pre-seed:
     *  - the 4 locale home URLs so the crawler picks each locale tree even
     *    if a translated link is missing (defense in depth — locale chips
     *    in the navbar should already cover this)
     *  - the iframe demo targets that are referenced via <iframe src="..."> on
     *    /{locale} and would otherwise be missed (the crawler doesn't follow
     *    iframe src, only <a href>)
     */
    'paths' => [
        '/ja',
        '/en',
